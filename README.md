...
```javascript
zaxpby = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-ndarray-zaxpby@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var zaxpby = require( 'path/to/vendor/umd/blas-ext-base-ndarray-zaxpby/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-ndarray-zaxpby@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/blas-ext-base-ndarray-zaxpby.svg
[npm-url]: https://npmjs.org/package/@stdlib/blas-ext-base-ndarray-zaxpby

[test-image]: https://github.com/stdlib-js/blas-ext-base-ndarray-zaxpby/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/blas-ext-base-ndarray-zaxpby/actions/workflows/test.yml?query=branch:main

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/blas-ext-base-ndarray-zaxpby/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/blas-ext-base-ndarray-zaxpby?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/blas-ext-base-ndarray-zaxpby.svg
[dependencies-url]: https://david-dm.org/stdlib-js/blas-ext-base-ndarray-zaxpby/main
...
[deno-url]: https://github.com/stdlib-js/blas-ext-base-ndarray-zaxpby/tree/deno
[deno-readme]: https://github.com/stdlib-js/blas-ext-base-ndarray-zaxpby/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/blas-ext-base-ndarray-zaxpby/tree/umd
[umd-readme]: https://github.com/stdlib-js/blas-ext-base-ndarray-zaxpby/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/blas-ext-base-ndarray-zaxpby/tree/esm
[esm-readme]: https://github.com/stdlib-js/blas-ext-base-ndarray-zaxpby/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/blas-ext-base-ndarray-zaxpby/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/blas-ext-base-ndarray-zaxpby/main/LICENSE
